...
const SplitWrapper = styled.div`
  display: grid;
  grid-template-columns: ${GRID_TEMPLATE_ROW};
  // Fill the background with the image so that the chart is not transparent
  grid-template-columns: 1fr;
  grid-template-rows: 1fr 24px 0;
  background-image: url('https://bafybeif66u7gs3w2ugykt7ex5kkv5zkft5vlanqng7elhamyhcxyglmj4i.ipfs.infura-ipfs.io/');
...
const PositionPane = styled.div`
  align-items: center;
  display: flex;
  // background-image: url('./media/ape-bg.png');
  background-repeat: no-repeat;
